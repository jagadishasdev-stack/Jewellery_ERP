...
const branchOrderRequestRoutes = require('./routes/branchOrderRequest');
const dealerTransactionRoutes = require('./routes/dealerTransaction');
const metalTransactionLedgerRoutes = require('./routes/metalTransactionLedger');
...
const simpleMastersRoutes = require('./routes/simpleMasters');
...
app.use('/api/branch-order-request', branchOrderRequestRoutes);
app.use('/api/dealer-transaction', dealerTransactionRoutes);
app.use('/api/metal-ledger', metalTransactionLedgerRoutes);
...
app.use('/api/simple-masters', simpleMastersRoutes);
